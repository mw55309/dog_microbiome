...
rule megahit:
	...
	shell: 
		'''
		mkdir -p {params.di} && megahit --continue --k-list 31,59,87 --kmin-1pass -m 0.95 --min-contig-len 1500 -m {resources.mem_mb} -t {threads} -1 {input.R1} -2 {input.R2} -o {params.di}
		'''
